...
const aggregationMetric = new Trend("aggregate_roles_users");

export default function () {
    common.xp_login("su", "password", restUrl);
    group("aggregate_roles_users", function () {

        let resp = common.aggregateRolesAndUsers(baseUrl);
        check(resp, {
            "status is 200": (resp) => {
            ...
            "transaction time OK": (resp) => {
                ...
                return body.data.userItemsConnection.totalCount == 11;
            }
        });
